              ...
              <div class="post-content" id="<?php echo $noti['id']; ?>">
                <div class="card" style="border-radius: 10px;">
                  ...
                  <div class="card-body">
                          ...
                          <?php } 
                                  if($noti['noti_url'] != ""){ ?>
                                      <a href="<?php echo $noti['noti_url']; ?>" class="btn btn-primary" style="float: right;"id="url_button">Follow Link</a>
                            <?php } ?>
                  </div> 
      ...
      if($_FILES['noti_pic']['name'] != ""){
          ...
          if(in_array($file_extension,$valid_ext)){  
            ...
            if(mysqli_query($link, $query)){
              ...
              echo "<script> window.location.assign('https://college-connect.in/?p=news'); </script>";
