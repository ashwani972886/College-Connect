    ...
    if(isset($_POST['save_teacher_info'])){
        ...
        if($_POST['sub'] == "" || $_POST['branch_bas'] == "branch" || $sem == "semester" || $_POST['sec_bas'] == "sec"){
            ...
            if(mysqli_query($link, $query1)) {
                ...
                echo "<scrip> alert('Details updated successfully'); </script>";

                echo "<scrip> window.location.assign('http://localhost/college_connect/?p=profedt'); </scrip>";
...
?>
            <script> if(confirm('Warning! Deleting the subject will also delete the group associated in the Chatroom')){
