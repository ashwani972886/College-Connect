<form style="margin-bottom: 10px;" method="POST">
    ...
    <div class="row">
        <div class="form-group col-xs-3">
            <select class="form-control" id="course_dt" name="course_dt">
        ...
        <div class="form-group col-xs-3">
            <select class="form-control" id="branch_dt_select1" name="branch_dt_select1">
            ...
            <select class="form-control" id="branch_dt_select2" name="branch_dt_select2">
                <option value="branch"  selected>Branch</option>
        ...
        <div class="form-group col-xs-3">
            <select class="form-control" id="sem_dt_1" name="sem_dt_1" disabled>
            ...
            <select class="form-control" id="sem_dt_2" name="sem_dt_2" disabled>
                <option value="semester" selected>Semester</option>
                <option value="1Sem">First Semester</option>
                <option value="2Sem">Second Semester</option>
                <option value="3Sem">Third Semester</option>
        ...
        <div class="form-group col-xs-3">
            <select class="form-control" id="sec_dt" name="sec_dt" disabled>
                <option value="sec" selected>Section</option>
                <option value="Sec_A">A</option>
                <option value="Sec_B">B</option>
            </select>
        </div>
        <button type="submit" class="btn btn-primary pull-right" style="margin-right: 15px; font-size: 20px;" name = "submit_dt">Go!</button>
    </div>
...
<div>
    ...
    <?php 
        ...
        if(isset($_POST['submit_dt'])){
            $course = $_POST['course_dt'];
                        
            if($course == "B.Tech"){

                $branch = $_POST['branch_dt_select1'];

            } else {

                $branch = $_POST['branch_dt_select2'];
