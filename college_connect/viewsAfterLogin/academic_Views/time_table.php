<form style="margin-bottom: 10px;" method="POST">
    ...
    <div class="row">
        <div class="form-group col-xs-3">
            <select class="form-control" id="course_tt" name="course_tt">
        ...
        <div class="form-group col-xs-3">
            <select class="form-control" id="branch_tt_select1" name="branch_tt_select1">
            ...
            <select class="form-control" id="branch_tt_select2" name="branch_tt_select2">
                <option value="branch"  selected>Branch</option>
        ...
        <div class="form-group col-xs-3">
            <select class="form-control" id="sem_tt_1" name="sem_tt_1" disabled>
            ...
            <select class="form-control" id="sem_tt_2" name="sem_tt_2" disabled>
                <option value="semester" selected>Semester</option>
                <option value="1Sem">First Semester</option>
                <option value="2Sem">Second Semester</option>
                <option value="3Sem">Third Semester</option>
        ...
        <div class="form-group col-xs-3">
            <select class="form-control" id="sec_tt" name="sec_tt" disabled>
                <option value="sec" selected>Section</option>
                <option value="Sec_A">A</option>
                <option value="Sec_B">B</option>
            </select>
        </div>
        <button type="submit" class="btn btn-primary pull-right" style="margin-right: 15px; font-size: 20px;" name = "submit_tt">Go!</button>
    </div>
...
<div>
    ...
    <?php 
        ...
        if(isset($_POST['submit_tt'])){
            $course = $_POST['course_tt'];
                        
            if($course == "B.Tech"){

                $branch = $_POST['branch_tt_select1'];

            } else {

                $branch = $_POST['branch_tt_select2'];
